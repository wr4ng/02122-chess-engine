...
namespace KingIsInCheck
{
    ...
    public class inCheckTests
    {
        ...
        public void CheckedByPawn()
        {
            ...
            Assert.IsTrue(Check.CheckForPawns((7, 0), board, board.GetCurrentPlayer()));
            board = Board.ImportFromFEN("k7/8/8/8/8/8/7p/6K1 b KQkq - 0 1");
            Assert.IsTrue(Check.CheckForPawns((6, 0), board, board.GetCurrentPlayer()));
            board = Board.ImportFromFEN("k7/8/8/8/8/6K1/7p/8 b KQkq - 0 1");
            Assert.IsFalse(Check.CheckForPawns((6, 2), board, board.GetCurrentPlayer()));
        ...
        public void CheckedByBishop()
        {
            ...
            Assert.IsTrue(Check.CheckForBishops((7, 0), board, board.GetCurrentPlayer()));
            board = Board.ImportFromFEN("k7/8/8/8/8/7b/8/5K2 b KQkq - 0 1");
            Assert.IsTrue(Check.CheckForBishops((5, 0), board, board.GetCurrentPlayer()));
            board = Board.ImportFromFEN("k7/8/8/5K2/8/7b/8/8 b KQkq - 0 1");
            Assert.IsTrue(Check.CheckForBishops((5, 4), board, board.GetCurrentPlayer()));
        ...
        public void CheckedByRook()
        {
            ...
            Assert.IsTrue(Check.CheckForRooks((7, 0), board, board.GetCurrentPlayer()));
            board = Board.ImportFromFEN("k7/8/8/8/8/8/8/3r3K b KQkq - 0 1");
            Assert.IsTrue(Check.CheckForRooks((7, 0), board, board.GetCurrentPlayer()));
            board = Board.ImportFromFEN("k7/8/8/8/4K3/8/8/4r3 b KQkq - 0 1");
            Assert.IsTrue(Check.CheckForRooks((4, 3), board, board.GetCurrentPlayer()));
        ...
        public void CheckedByKnight()
        {
            ...
            Assert.IsTrue(Check.CheckForHorses((4, 3), board, board.GetCurrentPlayer()));
        }
        [TestMethod]
        public void CheckedByQueen()
        {
            Board board = Board.ImportFromFEN("k7/8/8/8/4K3/8/2q5/8 b KQkq - 0 1");
            Assert.IsTrue(Check.CheckForBishops((4, 3), board, board.GetCurrentPlayer()));
        ...
        public void CheckedByKing()
        {
            ...
            Assert.IsTrue(Check.CheckForKings((4, 3), board, board.GetCurrentPlayer()));
        }
    }
}